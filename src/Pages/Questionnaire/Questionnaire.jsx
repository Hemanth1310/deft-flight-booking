...
export const Questionnaire = () => {
    ...
    const pushFeedback = async () => {
        const feedsRef = ref(database, 'deft-feedback-complete');
        ...
        const FormattedData = ref(database, 'deft-formatted-data');
                    ...
                    <tbody>
                        {questions.map((question, index) => (
                            <tr
                                key={index}
                                className={`${
                                    invalidQuestions.includes(`${category}${index}`) ? 'invalid' : ''
                                }`}
                            >
